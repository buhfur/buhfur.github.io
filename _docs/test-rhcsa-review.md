...
# Review notes for RHCSA  [TOC](#table-of-contents)

This document mainly contains command snippets of the various CLI tools used for the exam 


## Resetting Root Password  [TOC](#table-of-contents)
...
## Managing disks [TOC](#table-of-contents)
...
## unrelated helpful snippets   [TOC](#table-of-contents)
...
## output redirection & piping  [TOC](#table-of-contents)
...
## swapfiles [TOC](#table-of-contents)
...
## Variables  [TOC](#table-of-contents)

`$LANG=en_US.UTF-8` -> sets language for system , using UTF-8 encoding 

`env` -> shows environment variables 

## Bash Environment  [TOC](#table-of-contents)
...
## mount & mount related commands    [TOC](#table-of-contents)
...
## gzip & bzip2 & xz  [TOC](#table-of-contents)
...
## grep & regex  [TOC](#table-of-contents)
...
## emergency reset  [TOC](#table-of-contents)

`echo b > /proc/sysrq-trigger`


## User and Group management  [TOC](#table-of-contents)
...
## sudo file  [TOC](#table-of-contents)
...
## chage & passwd   [TOC](#table-of-contents)
...
## Special permissions basics  [TOC](#table-of-contents)
...
## groupmems  [TOC](#table-of-contents)
...
## User-extended attributes  [TOC](#table-of-contents)
...
## hostname  [TOC](#table-of-contents)
...
## systemctl [TOC](#table-of-contents)
...
## Journalctl  [TOC](#table-of-contents)
...
# Steps to create a LVM  [TOC](#table-of-contents)
---
...
## Resizing Root Logical Volume on Proxmox  [TOC](#table-of-contents)
...
## Resizing Filesystems  [TOC](#table-of-contents)
...
## /etc/exports example [TOC](#table-of-contents)
...
## Get list of exported directories from NFS server   [TOC](#table-of-contents)

`showmount -e nfsserver` -> show shares that are available  

## Mounting NFS share through fstab  [TOC](#table-of-contents)

```bash
servername:/sharename /nfs/mount/point nfs sync 0 0 
```

## autofs summary  [TOC](#table-of-contents)
...
## Autofs Configuration Example  [TOC](#table-of-contents)
...
# SELinux  [TOC](#table-of-contents)
---

## Terminology  [TOC](#table-of-contents)
...
## General Commands / Snippets  [TOC](#table-of-contents)
...
## Add Context type to directory  [TOC](#table-of-contents)
